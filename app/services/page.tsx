            ...
            {[
              {
                ...
                price: "From US$ 5,000",
                images: ["/projects/mobile1.jpg", "/projects/mobile2.jpg", "/projects/mobile3.avif"],
              },
              {
                title: "Bespoke Websites",
                price: "From US$ 10,000",
                images: ["/projects/mobile4.jpg", "/projects/mobile5.jpg", "/projects/mobile6.jpg"],
              },
              {
                title: "Digital Product Design",
                price: "From US$ 15,000",
                images: ["/projects/mobile2.jpg", "/projects/mobile3.avif", "/projects/mobile4.jpg"],
              },
            ].map((service, i) => (
              <div
                key={i}
                className="border border-black/50 rounded-xl p-4 hover:border-black/40 transition"
              >
                ...
                <p className="text-sm text-black/50 mt-1">{service.price}</p>
              </div>
            ))}
          </div>
