...
import { FiArrowLeft, FiUser, FiExternalLink } from "react-icons/fi";
      ...
      <section className="relative pt-24 pb-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-black/5 shadow-sm mb-6 animate-fadeIn">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-black/60">Professional Identity</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 animate-fadeUp">
            Company <span className="text-blue-600">Profiles</span>
          </h1>
          
          <p className="text-lg md:text-xl text-black/60 max-w-2xl mx-auto leading-relaxed animate-fadeUp delay-150">
            We craft professional company profiles and business presentations that communicate your brand's vision, values, and strengths with clarity and impact.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 animate-pulse">
            ...
            <p className="text-black/40 font-medium">Loading profiles...</p>
          </div>
        ) : items.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-3xl border border-black/5 shadow-sm">
            <p className="text-black/40 text-lg">No company profiles featured yet.</p>
          </div>
        ) : (
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    {image && (
                      <img
                        src={image}
                        alt={item.title || "Company Profile"}
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    <h3 className="text-xl font-bold mb-3 group-hover:text-blue-600 transition-colors">
                      {item.title || "Business Presentation"}
                    </h3>
                    <p className="text-sm text-black/50 leading-relaxed mb-6 line-clamp-2">
                      {item.description || "Comprehensive brand storytelling and visual identity documentation for professional growth."}
                    </p>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-4xl mx-auto p-12 rounded-[3rem] bg-white border border-black/5 shadow-xl text-center relative overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Elevate your professional image?</h2>
            <p className="text-black/60 mb-10 max-w-lg mx-auto">
              We help you present your business in the best possible light. Let's build your professional narrative today.
            </p>
