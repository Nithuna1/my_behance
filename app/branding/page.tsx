...
import { FiArrowLeft, FiPenTool, FiExternalLink } from "react-icons/fi";
...
export default function BrandingPage() {
  ...
  const load = async () => {
    try {
      ...
      console.error("Failed to load branding items:", error);
    } finally {
      setLoading(false);
    }
  };
      ...
      <section className="relative pt-24 pb-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-black/5 shadow-sm mb-6 animate-fadeIn">
            <FiPenTool className="text-blue-600" />
            <span className="text-xs font-semibold uppercase tracking-wider text-black/60">Visual Identity</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 animate-fadeUp">
            Brand <span className="text-blue-600">Identity</span>
          </h1>
          
          <p className="text-lg md:text-xl text-black/60 max-w-2xl mx-auto leading-relaxed animate-fadeUp delay-150">
            We build iconic brand identities that stand out. From logo design to complete brand guidelines, we help your business find its unique voice.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 animate-pulse">
            ...
            <p className="text-black/40 font-medium">Loading branding projects...</p>
          </div>
        ) : items.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-3xl border border-black/5 shadow-sm">
            <p className="text-black/40 text-lg">No branding projects featured yet.</p>
          </div>
        ) : (
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    {image && (
                      <img
                        src={image}
                        alt={item.title || "Branding project"}
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <p className="text-sm text-black/50 leading-relaxed mb-6 line-clamp-2">
                      {item.description || "Strategic brand development and visual storytelling to elevate your market presence."}
                    </p>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-4xl mx-auto p-12 rounded-[3rem] bg-white border border-black/5 shadow-xl text-center relative overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to define your brand?</h2>
            <p className="text-black/60 mb-10 max-w-lg mx-auto">
              We help you build a brand that resonates with your audience and stands the test of time.
            </p>
